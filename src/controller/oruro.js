...
async function comprobacion() {
    ...
    const packQuery = "SELECT * FROM packages WHERE  VENTANILLA ='UNICA' AND TELEFONO IS NOT NULL AND TELEFONO <> 0 AND CUIDAD = 'ORURO' AND ESTADO = 'VENTANILLA';";
    // const packQuerySn = "SELECT * FROM packages WHERE  VENTANILLA ='UNICA' AND TELEFONO IS NOT NULL AND TELEFONO = 0 AND CUIDAD = 'ORURO' AND ESTADO = 'VENTANILLA';";
