...
exports.logout = async(req, res) => {
    // cerrarSesion(container.cliente)
    // inicio();
...
function envio(contacto, id) {
    ...
    const numero = "591" + 75281378 + "@c.us";
...
async function comprobacion() {
    ...
    const packQuery = "SELECT * FROM packages WHERE ZONA <> '' AND TELEFONO IS NOT NULL AND TELEFONO <> 0 AND CUIDAD = 'LA PAZ' AND ESTADO = 'VENTANILLA';";
    const packQuerySn = "SELECT * FROM packages WHERE ZONA <> '' AND TELEFONO IS NOT NULL AND TELEFONO = 0 AND CUIDAD = 'LA PAZ' AND ESTADO = 'VENTANILLA';";
