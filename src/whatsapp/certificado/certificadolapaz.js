...
async function ClientLP() {
 const lapaz = new Client({
  puppeteer: {
    ...
    authStrategy: new LocalAuth({ clientId: "lapazCer" }),
...
function codigoQRLPZC() {
  return QRlapaz;
}
function estadoConexionLPZC() {
  return estadoLapaz;
}
function callbackStatusLPZC() {
  return statusLapaz;
}function contactoLPZC() {
  return contacto;
}
...
module.exports = { ClientLP,contactoLPZC, codigoQRLPZC, estadoConexionLPZC, enviarMensaje, callbackStatusLPZC, cerrarSesion };
