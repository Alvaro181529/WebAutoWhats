...
const { beniController, NotesbeniController, NotesCreatebeniController, NotesUpdatebeniController, NotesDelatebeniController, logout, beniControllerAuth,beniControllerMessage } = require("../controller/beni")
const router = Router();
