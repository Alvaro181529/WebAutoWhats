...
const { tarijaController, NotestarijaController, NotesCreatetarijaController, NotesUpdatetarijaController, NotesDelatetarijaController,logout, tarijaControllerAuth, tarijaControllerMessage } = require("../controller/tarija")
const router = Router();
